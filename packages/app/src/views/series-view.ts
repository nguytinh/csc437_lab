...
export class SeriesViewElement extends LitElement {
  render() {
    return html`
      <main>
        <div class="page-header">
          ...
          <p>Collections of related games sharing characters, worlds, or gameplay mechanics.</p>
        </div>
          ...
          <div class="card-grid">
            <div class="card series-card">
              <div class="card-header">
                <h3 class="card-title">⚔️ The Legend of Zelda</h3>
              </div>
              <div class="card-content">
                <p>Nintendo's iconic action-adventure series following Link's quest to save Hyrule and Princess Zelda</p>
                <div class="games-list">
                  <strong>Games in Series:</strong> 
                  <a href="/app/games/zelda-botw">Breath of the Wild</a>, 
            ...
            <div class="card series-card">
              ...
              <div class="card-content">
                <p>Microsoft's flagship FPS franchise featuring Master Chief in epic sci-fi warfare</p>
                <div class="games-list">
                  <strong>Games in Series:</strong> 
            ...
            <div class="card series-card">
              ...
              <div class="card-content">
                <p>Nintendo's legendary platformer series starring the mustached plumber in colorful adventures</p>
                <div class="games-list">
                  <strong>Games in Series:</strong> 
            ...
            <div class="card series-card">
              <div class="card-header">
                <h3 class="card-title">⚽ FIFA / FC</h3>
              </div>
              <div class="card-content">
                <p>EA's annual football simulation series featuring official leagues, teams, and players</p>
                <div class="games-list">
                  <strong>Games in Series:</strong> 
                  <a href="/app/games/fifa-24">EA Sports FC 24</a>, 
                  FIFA 23, 
                  FIFA 22
                </div>
              </div>
            ...
            <div class="card series-card">
              <div class="card-header">
                <h3 class="card-title">🏝️ Animal Crossing</h3>
              </div>
              <div class="card-content">
                <p>Nintendo's beloved life simulation series where you build and customize your own island community</p>
                <div class="games-list">
                  <strong>Games in Series:</strong> 
                  <a href="/app/games/animal-crossing">New Horizons</a>, 
                  New Leaf, 
                  Wild World
                </div>
              </div>
        ...
        <section class="relationships">
          <h2>📚 Series Connections</h2>
          <ul>
            <li>
              <a href="/app/games">Games</a>
              <span class="relationship-type">part of</span>
              <span class="entity">Series</span>
            </li>
            <li>
              <span class="entity">Series</span>
              <span class="relationship-type">collection of</span>
              <a href="/app/games">Games</a>
            </li>
          </ul>
        </section>
